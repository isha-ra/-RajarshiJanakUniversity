                ...
                <div class="col-md-9 mx-auto shadow p-5">
                    ...
                    <form method="post" action="/education/{{$education->education_id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <input type="number" name="staff_id"  readonly class="form-control" value="{{$education->staff_id}}">
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <input type="date" name="completed_year"   class="form-control" value="{{$education->completed_year}}" placeholder="Select completed year">
                        </div>
